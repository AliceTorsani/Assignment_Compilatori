...
; OUTPUT DEL PASSO:
; Loop Invariant:   %13 = add nsw i32 10, 20
; Loop Invariant:   %14 = sdiv i32 %13, 10
; Loop Invariant:   %15 = sitofp i32 %14 to float
; Loop Invariant:   %20 = fneg float %15
; Loop Invariant:   %6 = add nsw i32 10, 20
; Loop Invariant:   %7 = mul nsw i32 %6, 2
; Loop Invariant:   %9 = getelementptr inbounds [100 x i32], ptr %2, i64 0, i64 0
; Loop Invariant:   %10 = load i32, ptr %9, align 4
; Loop Invariant:   %11 = add nsw i32 %6, %7
; Loop Invariant:   %14 = add nsw i32 %7, 3